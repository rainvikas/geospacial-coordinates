<template>
    ...
    <div class="main">
      ...
      <div class="right1">
        <v-map class="w-full h-full" :options="state.map" @loaded="getMapData">
          <div class="zIndex1 bg-green-500 rounded-lg w-5/12" v-show="info.show">
            <div class="p-2">
              <table class="p-2">
                <tr class="p-1">
                  <td class="p-1">
                ...
                <tr class="p-1">
                  <td class="p-1">
                    <button
                      @click="submit"
                      class="rounded-xl p-1 text-black bg-green-500 hover:bg-blue-600"
                    >
                      Submit
                    </button>
                  </td>
  ...
  async function submit() {
    ...
    let formData = {
      id: "1",
      Name: info.data1.name,
      discription: info.data1.desc,
      Geom: info.data1.geom,
    };
